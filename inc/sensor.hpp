...
void HTS221_Get_Humidity(uint16_t* value)
{
	...
	i2c.readFromExternRegister(hts22_adr, hts22_H0_rH_x2, &buffer[0], 1);
	i2c.readFromExternRegister(hts22_adr, hts22_H1_rH_x2, &buffer[1], 1);
	...
	i2c.readFromExternRegister(hts22_adr, hts22_H0_T0_OUT_0, &buffer[0], 1);
	i2c.readFromExternRegister(hts22_adr, hts22_H0_T0_OUT_1, &buffer[1], 1);

	H0_T0_out = (((uint16_t)buffer[1])<<8) | (uint16_t)buffer[0];

	/*3. Read H1_T0_OUT */

	i2c.readFromExternRegister(hts22_adr, hts22_H1_T0_OUT_0, &buffer[0], 1);
	i2c.readFromExternRegister(hts22_adr, hts22_H1_T0_OUT_1, &buffer[1], 1);

	H1_T0_out = (((uint16_t)buffer[1])<<8) | (uint16_t)buffer[0];

	/*4. Read H_T_OUT */

	i2c.readFromExternRegister(hts22_adr, hts22_THUMIDITY_OUT_L, &buffer[0], 1);
	i2c.readFromExternRegister(hts22_adr, hts22_THUMIDITY_OUT_H, &buffer[1], 1);
